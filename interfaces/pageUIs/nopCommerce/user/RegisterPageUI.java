...
public class RegisterPageUI {
	...
	public static final String REGISTER_SUCCESS_MESSAGE = "//span[@id='ConfirmPassword-error']";
	public static final String LOGOUT_LINK = "//a[@class='button-1 register-continue-button']";
	public static final String EXISTING_EMAIL_ERROR_MESSAGE = "//span[@id='ConfirmPassword-error']";
